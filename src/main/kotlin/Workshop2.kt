...
fun main() {
    ...
    // หาผลรวมของราคา
//    val totalElecPriceNotOver1000 = products.filter {
//        it.price <= 1000
//    } .sumByDouble { it.price }
//    val totalElecPricebetween = products.filter {
//        it.price <= 1000
//    } .sumByDouble { it.price }
//    val totalElecPriceOver10000 = products.filter {
//        it.price >= 1000.0 && it.price <= 9999.0
//    } .sumByDouble { it.price }

    val FilterPrice = products
        .groupBy { product ->
            when {
                product.price <= 1000 -> "💸 ไม่เกิน 1,000"
                product.price in 1000.0..9999.0 -> "💵 ระหว่าง 1,000 - 9,999"
                else -> "🤑 มากกว่า 10,000"
            }
        }

    FilterPrice.forEach { (range,item) ->
        println("$range")
